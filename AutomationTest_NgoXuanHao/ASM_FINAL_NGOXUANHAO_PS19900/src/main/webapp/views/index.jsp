...
<body >	
 ...
 <!--  <img src="image/background-header.jpg" alt="" width="1475" height="250">	 -->
   <img src="image/background-header1.jpg" alt="" width="1475" height="300">		
  </header>
		<jsp:include page="nav.jsp"></jsp:include>	
	 <div class ="row" style="height: 680px; background-color: pink ; margin : 0;"> <jsp:include page="${VIEW}"></jsp:include>	</div>	
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="footer__top__logo">
                            <a  href="./Home" class="navbar-brand" href="#" style="color: white;">
