...
public class InsertData extends TestData implements log<InsertData> {
	...
	@Override
	public void writeLog(String src, String sheetName, Set<InsertData> logs) throws IOException {
	...
	@Override
	public void writeDataRow(InsertData log, Row row, XSSFSheet sheet) throws IOException {
